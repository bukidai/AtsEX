...
namespace AtsEx.Extensions.TrainDrawPatch
{
    ...
    public interface ITrainDrawPatchFactory
    {
        ...
        TrainDrawPatch Patch(Train target, IMatrixConverter worldMatrixConverter);
        ...
        /// <returns>パッチを表す <see cref="TrainDrawPatch"/>。</returns>
        TrainDrawPatch Patch(Train target, IMatrixConverter worldMatrixConverter, IMatrixConverter viewMatrixConverter);
        ...
        /// <returns>パッチを表す <see cref="TrainDrawPatch"/>。</returns>
        TrainDrawPatch Patch(Train target, Action<Direct3DProvider, Matrix> overrideAction);
    }
}
