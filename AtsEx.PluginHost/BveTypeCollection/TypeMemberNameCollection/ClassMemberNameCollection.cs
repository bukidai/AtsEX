...
namespace Automatic9045.AtsEx.PluginHost.BveTypeCollection
{
    internal class ClassMemberNameCollection : TypeMemberNameCollectionBase
    {
        ...
        public ClassMemberNameCollection(string wrapperTypeName, string originalTypeName, List<TypeMemberNameCollectionBase> children) : base(wrapperTypeName, originalTypeName, children)
        {
